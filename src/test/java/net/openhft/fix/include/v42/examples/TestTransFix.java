...
public class TestTransFix {
    ...
    /**
     * Test the validity (check like 8|9|34|35|49|56|10 ) of a FIX message fed to FixMessage object checked
     * out from the pool. Rejects on incorrect message.
     */
    @Test
    ...
    // todo sometimes fails when we run all the tests together
    @Ignore
    @Test(timeout = 120000)
