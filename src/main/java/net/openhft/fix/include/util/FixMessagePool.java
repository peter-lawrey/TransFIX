...
/**
 * Off-heap, lock-free FixMessage object pool. All checkouts from the pool are ThreadLocal-based and can be obtained 
 * even before the threadlocal releases it. 
 *
 */
public class FixMessagePool implements FixPoolFactory<FixMessage>{
	...
	/**
	 * Constructor to create FixMessage objects and initialize the pool with default FixConfig. @param fixPoolFactory should be null 
	 * for implementation of FixPoolFactory as this class. 
	 * 
	 ...
	 * @param useDefault -instructs to create from FixConfig. Currently, only default=true implemented.
	 */
	...
	/**
	 * Checks out an unused FixMessage object from the pool. The FixMessage object needs to be obtained from its
	 * FixMessageContainer
	 * @return FixMessageContainer<FixMessage>
	 */
	...
	/**
	 * Static Inner class used as a container for FixMessage objects. This is used for maintaining the state of the 
	 * FixMessage Object's state. The state of a FixMessage object can be either in-use OR available.  
	 *
	 * @param <FixMessage>
	 */
